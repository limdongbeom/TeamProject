...
cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 594)
brightness = 50


trackbars = np.uint8(np.full((410, 584, 3), 255))#트랙바 크기조절
...
cv2.createTrackbar('Brightness', 'frame', 25, 50, brightness_change)#트랙바 범위조절
